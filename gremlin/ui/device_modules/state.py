"""Device state tracking models for real-time input monitoring.

This module provides models for tracking and displaying real-time state
of device inputs (axes, buttons, hats) in the UI.
"""
